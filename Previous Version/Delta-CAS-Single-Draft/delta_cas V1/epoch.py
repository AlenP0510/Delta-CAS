...
a new snapshot is written, and agents resume from the new base.
...
class EpochCoordinator:
    ...
    ----------
    interval : int
        How many versions between epoch boundaries. Default 5.
    """
    ...
    def check(self, store: "Store", current_version: int) -> None:  # noqa: F821
        ...
        If we've hit an epoch boundary, compact and signal all agents.
        """
